# Script to add remaining Chinese and Greek translations to phrases
$file = "index.html"
$content = Get-Content $file -Raw -Encoding UTF8

# Dictionary of phrase translations (English phrase -> {zh, el})
$translations = @{
    "You're welcome" = @{zh="不客气"; el="Παρακαλώ"}
    "Please" = @{zh="请"; el="Παρακαλώ"}
...
Write-Host "Translation dictionary created with $($translations.Count) entries"
Write-Host "Ready to process file..."
